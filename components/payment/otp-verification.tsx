...
export function OTPVerification({
  ...
  return (
    <Card className="shadow-xl border-0 max-w-md mx-auto">
      <CardHeader className="bg-gradient-to-r from-blue-50 to-cyan-50 text-center">
        <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
          <Smartphone className="w-8 h-8 text-blue-600" />
        </div>
        <CardTitle className="text-xl">تحقق من هويتك</CardTitle>
        <p className="text-gray-600 text-sm">تم إرسال رمز التحقق إلى رقم {maskedPhone}</p>
      </CardHeader>
